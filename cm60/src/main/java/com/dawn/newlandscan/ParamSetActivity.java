...
public class ParamSetActivity extends Activity implements View.OnClickListener {
    ...
    public void initView(String title){
        ...
        tv_minlen = (TextView) findViewById(R.id.tv_min_len);
        tv_maxlen = (TextView) findViewById(R.id.tv_max_len);
        et_minlen = (EditText) findViewById(R.id.et_min_len);
        et_maxlen = (EditText) findViewById(R.id.et_max_len);

        cb_Check = (CheckBox) findViewById(R.id.cb_Check);
        cb_Check.setOnClickListener(this);
        cb_TrsmtChkChar = (CheckBox) findViewById(R.id.cb_TrsmtChkChar);
        cb_TrsmtChkChar.setOnClickListener(this);
        cb_Digit2 = (CheckBox) findViewById(R.id.cb_Digit2);
        cb_Digit2.setOnClickListener(this);
        cb_Digit5 = (CheckBox) findViewById(R.id.cb_Digit5);
        cb_Digit5.setOnClickListener(this);
        cb_AddonRequired = (CheckBox) findViewById(R.id.cb_AddonRequired);
        cb_AddonRequired.setOnClickListener(this);
        cb_TrsmtStasrtStop = (CheckBox) findViewById(R.id.cb_TrsmtStasrtStop);
        cb_TrsmtStasrtStop.setOnClickListener(this);
        cb_FullAscii = (CheckBox) findViewById(R.id.cb_FullAscii);
        cb_FullAscii.setOnClickListener(this);
        cb_BitCode32Prech = (CheckBox) findViewById(R.id.cb_BitCode32Prech);
        cb_BitCode32Prech.setOnClickListener(this);
        cb_Code32SpecEdit = (CheckBox) findViewById(R.id.cb_Code32SpecEdit);
        cb_Code32SpecEdit.setOnClickListener(this);
        cb_Code32TrsmtChkChar = (CheckBox) findViewById(R.id.cb_Code32TrsmtChkChar);
        cb_Code32TrsmtChkChar.setOnClickListener(this);
        cb_Code32TrsmtStasrtStop = (CheckBox) findViewById(R.id.cb_Code32TrsmtStasrtStop);
        cb_Code32TrsmtStasrtStop.setOnClickListener(this);
        cb_TrsmtSysDigit = (CheckBox) findViewById(R.id.cb_TrsmtSysDigit);
        cb_TrsmtSysDigit.setOnClickListener(this);
        cb_MsgToupca = (CheckBox) findViewById(R.id.cb_MsgToupca);
        cb_MsgToupca.setOnClickListener(this);
        cb_Tdoupca = (CheckBox) findViewById(R.id.cb_Tdoupca);
        cb_Tdoupca.setOnClickListener(this);
        cb_Uscode = (CheckBox) findViewById(R.id.cb_Uscode);
        cb_Uscode.setOnClickListener(this);
        cb_Gs1Coupon = (CheckBox) findViewById(R.id.cb_Gs1Coupon);
        cb_Gs1Coupon.setOnClickListener(this);
        cb_ReqCoupon = (CheckBox) findViewById(R.id.cb_ReqCoupon);
        cb_ReqCoupon.setOnClickListener(this);
        cb_Coupon = (CheckBox) findViewById(R.id.cb_Coupon);
        cb_Coupon.setOnClickListener(this);
        cb_CloseSysChar = (CheckBox) findViewById(R.id.cb_CloseSysChar);
        cb_CloseSysChar.setOnClickListener(this);

        btn_save_param = (Button) findViewById(R.id.btn_save_param);
        ...
        for(EngineCode code : SoftScanService.engineCodeList){
