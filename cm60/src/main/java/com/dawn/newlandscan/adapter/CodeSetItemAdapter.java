...
public class CodeSetItemAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            holder.checkBox_enable = (CheckBox) convertView.findViewById(R.id.cb_codeset_enable);
            holder.textView_name = (TextView) convertView.findViewById(R.id.tv_codeset_name);
            holder.button_detail = (Button) convertView.findViewById(R.id.btn_details);
